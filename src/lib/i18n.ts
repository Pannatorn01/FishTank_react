...
const en: Dict = {
  ...
  'tool.select.desc': 'Select — drag to select a rectangular area (M) • drag inside to move it, drag a yellow corner/edge handle to resize (scales the artwork inside), drag the handle above to rotate freely • hold Ctrl while dragging to leave a copy behind • arrow keys nudge by 1px • Esc or click outside to deselect',
  'tool.select.short': 'Rectangle Select',
  'tool.lasso.desc': 'Lasso — drag to trace a freeform selection • drag inside to move it, drag the handle above to rotate freely • hold Ctrl while dragging to leave a copy behind • arrow keys nudge by 1px • Esc or click outside to deselect',
  'tool.lasso.short': 'Lasso',
  'tool.magicWand.desc': 'Magic Wand — click to select the connected area of matching color • hold Shift and click to select every matching pixel in the layer • drag inside to move the selection, drag the handle above to rotate freely • hold Ctrl while dragging to leave a copy behind • arrow keys nudge by 1px • Esc or click outside to deselect • see Tolerance below to select similar (not just identical) colors',
