...
## 9. ❓ คำถามที่ต้องถามผู้ใช้ก่อนเริ่ม P5

| # | คำถาม |
|---|---|
| Q1 | **เวลาเดินยังไง** — เรียลไทม์ (ปิดแอปแล้วปลายังหิว/ตายได้) หรือเดินเฉพาะตอนเปิดแอป? |
| Q2 | ถ้าเรียลไทม์ — ปิดไป 3 วันกลับมาปลาตายหมดเลยไหม? มีเพดานความเสียหายไหม? |
| Q3 | **ค่าสถานะโชว์ยังไง** — bar ต่อตัวปลา / bar รวมของตู้ / ไม่โชว์เลยให้ดูจากอาการ? |
| Q4 | **ลูกปลา** — ใช้สไปรท์พ่อแม่ตัวไหน? สุ่ม? ตัวเล็กแล้วค่อยโต? หรือให้ผู้ใช้วาดเอง? |
| Q5 | **ตาย** — หายไปเลย / ลอยน้ำต้องเก็บออก / มีสุสาน? กู้คืนได้ไหม? |
| Q6 | **แมว / นก** — สุ่มเวลาไหน? ป้องกันยังไง (คลิกไล่ / ซื้อฝาปิด / ต้องอยู่หน้าจอ)? |
| Q7 | **มีเงิน / ร้านค้าไหม** — ซื้ออาหาร ของตกแต่ง อัปเกรด? หรือเป็นเกมดูแลล้วน ๆ? |
| Q8 | **แพ้ได้ไหม** — ปลาตายหมด = จบเกม? หรือเริ่มใหม่ได้เรื่อย ๆ? |
| Q9 | **ศิลป์ฉากห้อง** — ผู้ใช้วาดเองผ่าน room decor ทั้งหมด หรือมีฉากห้องสำเร็จรูปให้เลือก? (จากภาพตัวอย่างดูเหมือนอยากได้ฉากสำเร็จรูป — ขอยืนยัน) |
| Q10 | **UI** — Build / Life เป็นแท็บแยก (3 แท็บ) หรือปุ่ม toggle ในแท็บ Fish Tank เดิม? |
| Q11 | ตู้เดียวหรือหลายตู้? เก็บ preset ตู้ได้ไหม? |
