...
**เสร็จเมื่อ:** round-trip test ผ่านทุกขนาด · เปิดไฟล์ backup JSON เก่าได้เหมือนเดิม ·
วัดขนาด `fishtank.sprites.v1` ก่อน/หลังจริง แล้วบันทึกตัวเลขกลับมาที่เอกสารนี้
